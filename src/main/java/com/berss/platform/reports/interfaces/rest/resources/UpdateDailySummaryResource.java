...
/**
 * Resource to update a daily summary
 *
 * @param entryTime decimal hour (e.g. 9.5 for 09:30).
 * @param exitTime decimal hour (e.g. 17.5 for 17:30).
 * @param score 0..10 score.
 * @param inputAmount monetary amount produced that day.
 */

public record UpdateDailySummaryResource(Double entryTime, Double exitTime, Integer score, Double inputAmount) {
